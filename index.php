    ...
    <div class="container">
            ...
            <section class="main-layout">
                <div class="row">
                    ...
                    foreach ($categoryList as $item) {
                        echo '
                                    <div class="box">
                                        <a href="danhmuc.php?id_category=' . $item['id'] . '">
                                            <p>' . $item['name'] . '</p>
                                            <div class="bg"></div>
                                            <img src="images/bg/'.$item['img'].'.jpg" alt="">
                                        </a>
                                    </div>
                                    ';
                    }
        ...
        <section class="main">
            <section class="recently">
                ...
                <div class="product-recently">
                    <div class="row">
                        <?php
                        $sql = 'SELECT * FROM product ORDER BY luot_xem DESC LIMIT 4;';
        ...
        <section class="main">
            ...
            <section class="restaurants">
                <div class="title">
                    <h1>CÁC MÓN HÀNG TỪ <span class="green">YIREN COSER</span></h1>
                </div>
