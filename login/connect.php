...
// $dbname="yirencos_sanphamcosplay1"; //tên database sẽ kết nối đến
// $username = "yirencos_datdntdps32670"; //username để kết nối đến database 
// $password = "Dntd079204032789"; // mật khẩu để kết nối đến database
...
$host = "localhost"; //địa chỉ mysql server sẽ kết nối đến
$dbname="asm1"; //tên database sẽ kết nối đến
